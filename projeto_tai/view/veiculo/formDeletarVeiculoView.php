...
<body>
    ...
    $objetoVeiculoController = new VeiculoController();


    if (!empty($_POST['confirmar'])) {
        //chama o metodo DELETAR recebendo os dados do usuário através do metodo $_POST
        $objetoVeiculoController->remove($_GET['id']);
    ...
    <form action="formDeletarVeiculoView.php?id=<?php echo $_GET['id']; ?>" method="POST" , align="center">
